 ...
 */
class Technooze_Tcategoryacl_Helper_Hidden extends Mage_Core_Helper_Abstract
{
    /**
     ...
     * @return Technooze_Tcategoryacl_Helper_Hidden
     */
    ...
    protected function _applyHiddenEntityRedirect($entityTypeCode)
    {
        ...
        switch ($type) {
            case Technooze_Tcategoryacl_Model_System_Config_Source_HiddenEntityHandling::HIDDEN_ENTITY_HANDLING_REDIRECT:
                return $this->_applyEntityRedirectTargetRoute($targetRouteSetting);
                break;

            case Technooze_Tcategoryacl_Model_System_Config_Source_HiddenEntityHandling::HIDDEN_ENTITY_HANDLING_REDIRECT_PARENT:
     ...
     * @return Technooze_Tcategoryacl_Model_Observer
     */
